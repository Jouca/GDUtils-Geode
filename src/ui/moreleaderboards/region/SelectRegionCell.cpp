...
bool SelectRegionCell::init(std::string mod) {
    ...
    const char* checkFrame = (id_ctr != country_id)
        ? "GJ_checkOff_001.png"
        : "GJ_checkOn_001.png";
    auto viewSpr = cocos2d::CCSprite::createWithSpriteFrameName(checkFrame);
    viewSpr->setScale(.575f);
    auto viewBtn = CCMenuItemSpriteExtra::create(
        viewSpr, this, menu_selector(SelectRegionCell::onClick)
    );
...
void SelectRegionCell::onClick(cocos2d::CCObject*) {
